...
const TipsPage = () => {
  ...
  <div>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 my-5 bg-[#230D41FF] animate__animated animate__bounce animate__delay-2s">
